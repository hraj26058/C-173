...
AFRAME.registerComponent("markerhandler", {
  ...
  handleRatings: async function (dish) {
    ...
    var tNo;
    tableNumber<=9?(tNo=`T0${tableNumber}`):`T${tableNumber}`;
    
    var orderSummary=await dish.getOrderSummary(tNo);
    var current_order=Object.keys(orderSummary.current_orders);
